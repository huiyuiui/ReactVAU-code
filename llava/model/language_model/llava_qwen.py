...
class LlavaQwenForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        if inputs_embeds is None:
            (input_ids, position_ids, attention_mask, past_key_values, inputs_embeds, labels) = self.prepare_inputs_labels_for_multimodal(input_ids, position_ids, attention_mask, past_key_values, labels, images, modalities, image_sizes, pg_scores=pg_scores)
    ...
    def generate_online(
        ...
        **kwargs,
        ...
        for frame_idx in range(image_features.shape[0]):
            ...
            print("Processed frame:", frame_idx+1, "/", image_features.shape[0], end="\r")
